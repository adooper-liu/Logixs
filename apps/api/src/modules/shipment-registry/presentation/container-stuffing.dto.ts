...
export class ContainerStuffingVgmDto {
...
export class ContainerStuffingVgmResponseDto extends ContainerStuffingVgmDto {
  @ApiProperty({ enum: ["KGM"] }) weightUnit!: "KGM";
}

export class ContainerStuffingSnapshotDto {
  ...
  @ApiPropertyOptional({
    type: ContainerStuffingVgmResponseDto,
    nullable: true,
  })
  vgm!: ContainerStuffingVgmResponseDto | null;
