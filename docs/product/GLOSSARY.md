...
| 货柜状态                        | 货柜实际走到哪；只由合法业务事件与证据推进                                                                                                    | [PRINCIPLES](./PRINCIPLES.md) §1.1；状态码权威见 CONTAINER_STATUS_MODEL                                                                                 |
| 任务状态                        | 员工作业做到哪；拥有独立任务生命周期，不复用货柜状态码                                                                                        | [PRINCIPLES](./PRINCIPLES.md) §1.1；具体状态集待任务领域模型定稿                                                                                        |
| 同步状态                        | 扫描/提交的确认进度；至少区分请求已接收、业务已接受、业务事实已落账，不能压成一个“同步成功”                                                   | [PRINCIPLES](./PRINCIPLES.md) §1.1；契约草案见 CONTRACTS_DRAFT                                                                                          |
| 管理维度                        | 对主流程节点与作业动作进行切分、聚合、比较和下钻的管理视角                                                                                    | [PRINCIPLES](./PRINCIPLES.md) §1.2                                                                                                                      |
| 主流程节点                      | 业务口径从备货单到还空箱；当前实施从已出运货柜列表起，未来向计划/采购等上游扩展                                                               | [PRINCIPLES](./PRINCIPLES.md) §1.2/§1.5；LIFECYCLE_CONSISTENCY                                                                                          |
| 作业动作                        | 员工或系统在某个主流程节点执行的有限动作；按任务定义组合前置检查、资料/资源、指令、实物操作、证据、结果与异常恢复，领取/扫描/报工并非固定步骤 | [PRINCIPLES](./PRINCIPLES.md) §1.2；NODE_PDCA/ACTION_CATALOG                                                                                            |
| 三层映射                        | 管理维度 × 主流程节点 × 作业动作的关联模型                                                                                                    | [PRINCIPLES](./PRINCIPLES.md) §1.2；任何信息与指标须可沿映射下钻                                                                                        |
