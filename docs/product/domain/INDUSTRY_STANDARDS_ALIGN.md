...
| #   | 纠偏                                                                                                                                                                                                      | 落到                                                                 |
| --- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- |
| W1  | **外部事件载荷共性**：供应商常见 `eventCode + eventTime + isEsti + place + source`；原始载荷保留为 R/S 证据，经 Adapter 映射到 CONTRACTS_DRAFT 的内部规范事件，不能直接成为我方共享契约                   | INTEGRATION / LIFECYCLE R0 / 事件契约                                |
