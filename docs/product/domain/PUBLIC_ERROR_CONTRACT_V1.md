...
| `LIFECYCLE_EVENT_PENDING_STUFFING_SNAPSHOT`       |  422 | precondition |
| `LIFECYCLE_EVENT_PENDING_STUFFING_SNAPSHOT_STALE` |  422 | precondition |
| `LIFECYCLE_EVENT_PENDING_STUFFING_EVIDENCE`       |  422 | precondition |
| `LIFECYCLE_EVENT_PENDING_DISPATCH_SNAPSHOT`       |  422 | precondition |
| `LIFECYCLE_EVENT_PENDING_DISPATCH_SNAPSHOT_STALE` |  422 | precondition |
| `LIFECYCLE_EVENT_PENDING_DISPATCH_EVIDENCE`       |  422 | precondition |
| `LIFECYCLE_EVENT_PENDING_LOCATION_CONTEXT`        |  422 | precondition |
| `LIFECYCLE_EVENT_PENDING_ROUTE_CONTEXT`           |  422 | precondition |
| `LIFECYCLE_EVENT_ROUTE_MISMATCH`                  |  422 | precondition |
| `LIFECYCLE_EVENT_PENDING_TERMINAL_AVAILABILITY`   |  422 | precondition |
| `LIFECYCLE_EVENT_PENDING_PICKUP_LOCATION_CONTEXT` |  422 | precondition |
| `LIFECYCLE_EVENT_PICKUP_LOCATION_MISMATCH`        |  422 | precondition |
| `LIFECYCLE_EVENT_PICKUP_BEFORE_AVAILABLE`         |  422 | precondition |
