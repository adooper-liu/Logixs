...
| [任务：出运后 Shipment 模型与四表字段基线评审](./planning/tasks/p6-post-departure-shipment-model-review.md) | 核定 Shipment 粒度、四域字段覆盖、只读详情投影和迁移门禁   | 评审中，待负责人批准            |
...
| [出运后核心模型差异 V1](product/domain/POST_DEPARTURE_CORE_MODEL_GAP_V1.md)                  | 当前 73 表与 Shipment 目标差异、统一 Handoff、四表字段覆盖、只读详情投影、扩展规则和迁移门禁                 | 技术评审完成，待批准 V1.4 |
...
| [IMPORT_DOMAIN_MODEL](product/domain/IMPORT_DOMAIN_MODEL.md)                                 | 当前备货单导入实现、统一 Handoff 目标入口与 Adapter 过渡边界                                                 | 过渡说明 v1.1             |
...
| [TARGET_FIELD_CATALOG](product/domain/TARGET_FIELD_CATALOG.md)                                   | 当前备货单兼容导入的 V1.0 建档、V1.1 产品明细及 V1.2 首组时间事实字段目录  | 正式兼容 V1.2 |
...
| [出运后 Shipment 模型与四表字段基线评审](./planning/tasks/p6-post-departure-shipment-model-review.md) | 本轮业务/数据/契约方向评审的唯一任务载体；设计正文只链接核心差异文档 | 评审中，待负责人批准        |
